...
export default function InformeProduccion2193Page() {
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El informe de producción 2193 se ha generado correctamente.',
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  return (
    <ModulePageLayout
      title="GENERAR INFORME PRODUCCION (2193)"
      description="Genere el informe de producción 2193 según los criterios seleccionados"
      actions={actions}
      maxWidth="7xl"
    >
      <Card className="mb-6 bg-purple-50/50">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            GENERAR INFORME PRODUCCION (2193)
          </CardTitle>
        </CardHeader>
        <CardContent>
