...
export default function TotalesInventarioPage() {
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El informe de totales de inventario se ha generado correctamente.',
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  return (
    <ModulePageLayout
      title="GENERAR INFORME TOTALES DE INVENTARIO"
      description="Genere el informe de totales de inventario según los criterios seleccionados"
      actions={actions}
      maxWidth="7xl"
    >
      <Card className="mb-6 bg-purple-50/50">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            GENERAR INFORME TOTALES DE INVENTARIO
          </CardTitle>
        </CardHeader>
        <CardContent>
          {/* Sección FECHAS */}
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="bodegas" className="text-sm font-medium">
                Bodegas
              </Label>
              <div className="relative">
                <select
