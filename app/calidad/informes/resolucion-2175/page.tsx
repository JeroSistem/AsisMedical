...
export default function Resolucion2175Page() {
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El informe Resolución 2175 se ha generado correctamente.',
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  return (
    <ModulePageLayout
      title="INFORME 2175"
      description="Genere el informe según Resolución 2175"
      actions={actions}
      maxWidth="7xl"
    >
