...
export default function InformeSismedPage() {
  ...
  const [tipoDocumento, setTipoDocumento] = useState('facturacion'); // Por defecto "Ventas según facturación"
  ...
  const handleNuevo = () => {
    ...
    setFechaFinal('');
    setEntidades('');
    setTipoDocumento('facturacion'); // Resetear al valor por defecto
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El informe SISMED se ha generado correctamente.',
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  return (
    <ModulePageLayout
      title="GENERAR INFORME REPORTE AL SISTEMA DE INFORMACION DE PRECIOS DE MEDICAMENTOS SISMED"
      description="Genere el informe para el sistema SISMED"
      actions={actions}
      maxWidth="7xl"
    >
      <Card className="mb-6 bg-purple-50/50">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            GENERAR INFORME REPORTE AL SISTEMA DE INFORMACION DE PRECIOS DE MEDICAMENTOS SISMED
          </CardTitle>
        </CardHeader>
        <CardContent>
          {/* Sección FECHAS */}
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                >
                  Ventas según inventario
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="facturacion" id="facturacion" />
                <Label
                  htmlFor="facturacion"
                  className="text-sm font-medium cursor-pointer"
                >
                  Ventas según facturación
                </Label>
              </div>
            </RadioGroup>
          </div>
