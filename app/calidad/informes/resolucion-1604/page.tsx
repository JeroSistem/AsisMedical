...
export default function Resolucion1604Page() {
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El listado Resolución 1604 se ha generado correctamente.',
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  return (
    <ModulePageLayout
      title="LISTADO RESOLUCION 1604"
      description="Genere el listado según Resolución 1604"
      actions={actions}
      maxWidth="7xl"
    >
