...
export default function Informe1552Page() {
  ...
  const [incluirColumnasAdicionales, setIncluirColumnasAdicionales] = useState(false);
  ...
  const handleNuevo = () => {
    ...
    setFechaFinal('');
    setEntidades('');
    setIncluirColumnasAdicionales(false);
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El informe 1552 se ha generado correctamente.',
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  return (
    <ModulePageLayout
      title="INFORME 1552"
      description="Genere el informe 1552 según los criterios seleccionados"
      actions={actions}
      maxWidth="7xl"
    >
        ...
        <CardContent>
          ...
          <div className="mb-6">
            <div className="flex items-center space-x-2">
              <Checkbox
                id="columnas-adicionales"
                checked={incluirColumnasAdicionales}
                onCheckedChange={(checked) => setIncluirColumnasAdicionales(checked === true)}
              />
              <Label
                htmlFor="columnas-adicionales"
