          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium">
                  {formData.mobilePhone || 'No especificado'}
                </p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Teléfono Fijo</p>
                <p className="text-sm font-medium">
                  {formData.landlinePhone || 'No especificado'}
                </p>
              </div>
            </div>
            <div>
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium">
                  {formData.allergies || 'Ninguna conocida'}
                </p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Problemas Activos</p>
                <p className="text-sm font-medium">
                  {formData.activeProblems || 'Ninguno'}
                </p>
              </div>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Observaciones Iniciales</p>
              <p className="text-sm font-medium">
                {formData.initialObservations || 'Ninguna'}
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm font-medium">
                    {formData.insuranceProvider || 'No especificado'}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground">Número de Seguro</p>
                  <p className="text-sm font-medium">
                    {formData.insuranceNumber || 'No especificado'}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm font-medium">
                    {formData.legalRepresentativeName || 'No especificado'}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground">Documento del Representante</p>
                  <p className="text-sm font-medium">
                    {formData.legalRepresentativeDocument || 'No especificado'}
                  </p>
                </div>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Teléfono del Representante</p>
                <p className="text-sm font-medium">
                  {formData.legalRepresentativePhone || 'No especificado'}
                </p>
              </div>
            </CardContent>
          </Card>
